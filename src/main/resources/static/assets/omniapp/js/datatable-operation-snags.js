...
var DatatableOperationSnagsJsonRemote = function () {
	// == Private functions
	...
	var demo = function () {
		...
		var datatable = $('#operation_snags_datatable').mDatatable({
			...
			data: {
		        ...
		        source: {
		          read: {
		            // sample GET method
		            method: 'GET',
		            url: '/get-operation-snags?id='+operationId,
		            map: function(raw) {
		              // sample data mapping
		              var dataSet = raw;
