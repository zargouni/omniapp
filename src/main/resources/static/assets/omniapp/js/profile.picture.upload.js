...
function uploadSingleFile(file) {
    ...
    xhr.open("POST", "/upload-profile-picture");
...
var singleUploadForm = document.querySelector('#profilePictureForm');
var singleFileUploadInput = document.querySelector('#input_picture');
